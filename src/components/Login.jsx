      ...
      <section className="flex justify-center items-center min-h-[70vh] bg-cover bg-center" style={{ backgroundImage: "url('./grade.webp')" }}>
        <div className="bg-white/80 rounded-3xl shadow-2xl p-10 w-full max-w-xl flex flex-col items-center">
          <div className="flex justify-center mb-6 w-full">
            <button
              className={`px-6 py-2 font-semibold rounded-l-full transition-colors duration-300 cursor-pointer ${
            ...
            <button
              className={`px-6 py-2 font-semibold rounded-r-full transition-colors duration-300 cursor-pointer ${
                !isLogin ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'
              }`}
          ...
          {isLogin ? (
            <form className="w-full flex flex-col items-center mt-8 space-y-8">
              ...
              <button
                type="submit"
                className="text-xl font-semibold cursor-pointer px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 transition text-white shadow-lg"
              >
                Login
              </button>
            </form>
            ...
            <form className="w-full flex flex-col items-center mt-8 space-y-8">
              ...
              <button
                type="submit"
                className="text-xl cursor-pointer font-semibold px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 transition text-white shadow-lg"
              >
                Signup
              </button>
            </form>
